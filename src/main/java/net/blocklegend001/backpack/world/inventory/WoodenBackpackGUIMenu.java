...
public class WoodenBackpackGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WoodenBackpackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SimplebackpackModMenus.WOODEN_BACKPACK_GUI, id);
		...
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 7, 53) {
		}));
		...
		this.customSlots.put(16, this.addSlot(new SlotItemHandler(internal, 16, 115, 34) {
		}));
		this.customSlots.put(17, this.addSlot(new SlotItemHandler(internal, 17, 133, 34) {
		}));
